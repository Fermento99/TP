...
public interface BookstoreFacade {
	...
	void setBookDB(BookDBService bookDB);
	void setCustomerDB(CustomerDBService customerDB);
	void setCustomerNotification(CustomerNotificationService customerNotification);
